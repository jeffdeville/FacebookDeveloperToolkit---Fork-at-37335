...
namespace Facebook.Session
{
    ...
    /// </summary>
    public class FacebookSessionFactory
    {
    ...
    public class FBMLSessionProvider
    {
        private HttpCookieCollection _requestCookies;
        private HttpCookieCollection _responseCookies;
        private NameValueCollection _inputParams;

        public FBMLSessionProvider(HttpCookieCollection requestCookies, HttpCookieCollection responseCookies, NameValueCollection inputParams)
        {
            _requestCookies = requestCookies;
            _responseCookies = responseCookies;
            _inputParams = inputParams;
    ...
    public class IFrameSessionProvider
    {
        private HttpCookieCollection _requestCookies;
        private HttpCookieCollection _responseCookies;
        private NameValueCollection _inputParams;
    ...
    public class ConnectSessionProvider
    {
        private HttpCookieCollection _requestCookies;
        private HttpCookieCollection _responseCookies;
        private NameValueCollection _inputParams;
