...
namespace Facebook.Rest
{
	public interface IStream : IRestBase
	{
		...
		Facebook.Schema.stream_data Get(System.Collections.Generic.List<string> sourceIds, DateTime? startTime, DateTime? endTime, int? limit);
		Facebook.Schema.stream_data Get(long viewerId, System.Collections.Generic.List<string> sourceIds, DateTime? startTime, DateTime? endTime, int? limit, string filter_key);
		void GetAsync(System.Collections.Generic.List<string> sourceIds, DateTime? startTime, DateTime? endTime, int? limit, Stream.GetCallback callback, object state);
		void GetAsync(long viewerId, System.Collections.Generic.List<string> sourceIds, DateTime? startTime, DateTime? endTime, int? limit, string filter_key, Stream.GetCallback callback, object state);
