...
namespace Facebook
{
    ...
    public static class Constants
    {
        ...
        public static string FacebookLoginUrl = "https://login.facebook.com/login.php?api_key={0}&auth_token={1}&v=1.0&popup";
        public static string FacebookLogoutUrl = "http://www.facebook.com/logout.php?api_key={0}&auth_token={1}&v=1.0&confirm=1";
        internal static string FacebookNamespace = "http://api.facebook.com/1.0/";
        public static string FacebookRequestExtendedPermissionUrl = "http://www.facebook.com/authorize.php?api_key={0}&v=1.0&ext_perm={1}";
