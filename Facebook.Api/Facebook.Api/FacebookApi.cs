...
namespace Facebook.Api
{
    ...
    public interface IFacebookRequestInfo
    {
        FacebookRequestType GetRequestType();
    }

    public class FacebookRequestInfo : IFacebookRequestInfo
    {
        #region Implementation of IFacebookRequestInfo

        public FacebookRequestType GetRequestType()
        {
    ...
    public class FacebookApi : RestBase, IFacebookApi
    {
        private const string APP_KEY = "1";
        private const string APP_SECRET = "2";
        
        public FacebookApi()
        {
            var session = new CanvasSession(APP_KEY, APP_SECRET);
            Initialize(session);
        }

        public FacebookApi(IFacebookSession session)
        {
            Initialize(session);
        }

        public IRedirectStrategy RedirectStrategy { get; set; }
        ...
        {
            RedirectStrategy = new DoNothingRedirectStrategy();
