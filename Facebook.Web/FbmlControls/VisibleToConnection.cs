...
namespace Facebook.Web.FbmlControls
{
    ...
    /// <a href="http://wiki.developers.facebook.com/index.php/Fb:visible-to-connection" target="_blank">here</a>.</para>
    /// </remarks>
    [ToolboxData("<{0}:VisibleToConnection runat=\"server\" />")]
    public class VisibleToConnection : ContentDisplayControl
    {
        /// <summary>
        ...
        {
            get { return FbmlConstants.FB_VISIBLE_TO_CONNECTION; }
        }
    }
}
