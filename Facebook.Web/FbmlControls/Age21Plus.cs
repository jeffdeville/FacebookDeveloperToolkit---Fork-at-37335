...
namespace Facebook.Web.FbmlControls
{
    ...
    /// <a href="http://wiki.developers.facebook.com/index.php/Fb:21-plus" target="_blank">here</a>.</para>
    /// </remarks>
    [ToolboxData("<{0}:Age21Plus runat=\"server\"></{0}:Age21Plus>")]
    public sealed class Age21Plus : MinimumAgeControl
    {
        /// <inheritdoc />
        protected internal override string ElementName
        {
            get { return FbmlConstants.FB_AGE_21_PLUS; }
        }
    }
}
