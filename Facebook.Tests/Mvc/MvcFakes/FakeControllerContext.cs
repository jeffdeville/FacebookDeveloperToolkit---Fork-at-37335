...
namespace Facebook.Tests.Mvc.MvcFakes
{
    ...
    public class FakeControllerContext : ControllerContext
    {
        ...
        public FakeControllerContext
            ...
            : base(new FakeHttpContext(new FakePrincipal(new FakeIdentity(userName), roles), formParams ?? new NameValueCollection(), queryStringParams ?? new NameValueCollection(), cookies, sessionItems), new RouteData(), controller)
        { }
    }
}